      ...
      <div className="p-6 bg-white rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Upload fileList={fileList} onChange={handleUpload} multiple>
              <div className="border-dashed border-2 border-gray-300 rounded-md p-4 text-center text-gray-500 cursor-pointer">
                + Upload
              </div>
            </Upload>
          </div>
